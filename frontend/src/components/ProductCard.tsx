    ...
    >
      {!product.inStock && (
        <div className="absolute inset-0 z-20 bg-white/60 backdrop-blur-[1px] pointer-events-none flex items-center justify-center">
          <span className="bg-gray-900 text-white text-[10px] font-black px-4 py-2 uppercase tracking-widest shadow-2xl rotate-[-10deg] border-2 border-white">OUT OF STOCK</span>
        </div>
      )}
        ...
        <div className="mt-auto space-y-4">
          ...
          {!product.inStock ? (
            ...
            <div className="space-y-3">
              ...
              >
                <i className="fas fa-cart-plus group-hover/btn:translate-x-1 transition-transform"></i> Add to cart
              </button>
            </div>
          )}
        </div>
